...
| [ ] | `BP2` | Terrain & Replay Build (M2 + M2.5 + M3A) | DR-002 (M3A locks event taxonomy + headless replay); DR-007 launch-material set frozen | M2 dig fixture + M2.5 micro reactor defense + headless replay verifier | - | - | - | - | - | - | Per-milestone done-criteria + BP closure note + T-CAPTURE summary grid + T-RELEASE `v0.2.0-bp2` pre-release + human-playtest gate. |
