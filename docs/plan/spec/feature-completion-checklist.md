...
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [x] | `BP0` | Foundation Build (M0) | DR-001/DR-024/DR-025/DR-026; DR-002 envelope locked | `cfctl run --scenario m0_blank` kickoff smoke at 60+120 Hz | - | - | - | 5 | 5 | - | M0 closed; bundles `m0_*` archived; tag-only tooling proof. |
| [x] | `BP1` | Micro Breach Build (M1 + M1.5) | DR-002 + DR-004 + DR-007 + DR-008 + DR-009 leans confirmed | `cf-e2e --script micro_breach_{win,loss}` | - | - | - | 5 | 5 | - | M1 + M1.5 closed; bundles `m1_*` + `m1.5_2026-05-08T01-2{7,8}*` archived. cf-e2e wins 4/4 + loses 3/3. |
| [ ] | `BP2` | Terrain & Replay Build (M2 + M2.5 + M3A) | DR-002 (M3A locks event taxonomy + headless replay); DR-007 launch-material set frozen; DR-052/053/054/055/056 universal-enhancement rows tracked per milestone | M2 dig fixture + M2.5 micro reactor defense + headless replay verifier | - | - | - | - | - | - | Per-milestone done-criteria + Universal Enhancement Done-Criteria (DR-056) PASS + BP closure note + T-CAPTURE summary grid + T-RELEASE `v0.2.0-prealpha` pre-release (was previously planned as `v0.2.0-bp2`; renamed per 2026-05-09 channel migration) + human-playtest gate. Workers MUST consult [[spec/milestone-enhancement-pass-m1-plus]] for universal + per-milestone enhancement rows on top of the M2/M2.5/M3A scope. |
...
| [ ] | `BP12` | Release Candidate (T-CONTENT-ART + T-CONTENT-NARRATIVE + T-LOCALIZATION + T-LIVEOPS finalization) | DR-044/DR-045/DR-046/DR-047/DR-051 closure plus BP12 Completion Meaning in [[spec/prototype-roadmap#BP12 Completion Meaning]] | Steam-ready build with complete title/menu/settings/tutorial/labs/mission/debrief/save loop, full launch-content roster, Bunker Defence/Breach Contract, replay/modding/server/accessibility/localization/telemetry/release packaging, narrative bible, Tier-A localized strings, telemetry/launch tooling | - | - | - | - | - | - | BP12 means releasable game candidate, not just tech-complete systems. Final art/narrative/localization/launch ops finalize HERE — NOT during BP2..BP11. |
...
| [x] | `M0-S01` | Cargo workspace with the crate layout above. | [[spec/prototype-roadmap#M0 — Engine Bootstrap]] | `corefall/game/Cargo.toml` + 29 crate `Cargo.toml`s + per-crate `AGENTS.md` files + `rust-toolchain.toml` (1.95.0) + `rustfmt.toml` + `clippy.toml` + `.cargo/config.toml` | - | - | - | 9 | 8 | 2 | All 29 crates compile via `cargo check --workspace --all-targets`. |
...
| [x] | `M0-S08` | Native run bundles compatible with `game/tools/prototype_run_check.py`; add a thin native helper or wrapper only if the milestone needs one. | [[spec/prototype-roadmap#M0 — Engine Bootstrap]] | All three M0 run bundles pass `python3 game/tools/prototype_run_check.py prototype_runs/native/<run>`. | - | - | - | 9 | 9 | 2 | No native helper needed; the canonical Python checker validates the Rust-generated bundles directly. |
...
| [ ] | `M2-S09` | Terrain observability: terrain/material inspection is available through `cfctl`, run-bundle summaries, and replay checksums. | [[spec/prototype-roadmap#M2 — Pixel Terrain And Materials]] · [[spec/ai-control-observability-layer]] | - | - | - | - | - | - | - | Prevents M2 from becoming a visual-only terrain demo that AI agents cannot inspect. |

### M2.5 - Micro Reactor Defense Fun Slice

| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M2.5-P00` | Milestone proof: Chunked terrain makes the game more fun than M1.5 by giving the player a tactical reason to dig, shape cover, and defend a reactor. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - | Milestone-level proof row. |
| [ ] | `M2.5-S01` | 60-90 second `micro_reactor_defense` scenario with reactor hp, timer, enemy pressure, win, and `reactor_destroyed` loss. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - |  |
| [ ] | `M2.5-S02` | Reactor is a damageable static actor/object, not a fake objective flag. It emits damage/status/death events and participates in projectile hits. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - | Base power network waits until later. |
| [ ] | `M2.5-S03` | Win path requires M2 chunked terrain interaction: dig trench/cover, use material affordances, and record terrain event counts. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - |  |
| [ ] | `M2.5-S04` | Loss path proves the threat is real: reactor can be destroyed and the reason label is visible in HUD, events, run bundle, and capture grid. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - |  |
| [ ] | `M2.5-S05` | T-CAPTURE summary grid exists for win and loss scripts, and the agent visually confirms terrain edits + reactor state. | [[spec/prototype-roadmap#T-CAPTURE — Frame Capture, Grid Composer, And BP Fun-Proof Automation]] | - | - | - | - | - | - | - | Mandatory for BP2 closure. |
| [ ] | `M2.5-S06` | Human-playtest survey row asks whether M2/M2.5 is more fun than M1.5 and references the `summary_grid.png` path. | [[spec/prototype-roadmap#Build Points (Roadmap V2)]] | - | - | - | - | - | - | - |  |

### M3A - Event Recorder Core

| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M3A-P00` | Milestone proof: prior BP2 runs can replay headlessly and produce identical actor/terrain/inventory checksums. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - | M3A refreshes DR-002; M3B closes it. |
| [ ] | `M3A-S01` | Event taxonomy lock: event envelope, category baseline, required-field rejection, parent ids, schema versions. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] · [[references/prototype-run-bundle-schema]] | - | - | - | - | - | - | - |  |
| [ ] | `M3A-S02` | Snapshot/checksum writer for actor, inventory, terrain, objectives, and mission state. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3A-S03` | Headless replay verifier for M1.5, M2, and M2.5 bundles, with first-divergence reporting. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3A-S04` | Recorder backpressure: non-blocking writer, dropped-event counters, memory bounds, and stress fixtures. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3A-S05` | `expected_outcome` contract enforced by canonical run-bundle checker for clean, panic, and abort runs. | [[spec/native-implementation-backlog#M3A — Event Recorder Core]] | - | - | - | - | - | - | - |  |

### M3B - Replay Viewer And Debrief

| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M3B-P00` | Milestone proof: player/agent can scrub a run, filter events, and understand why death, mission loss, or reactor destruction happened. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - | BP3 polish; DR-002 closes here. |
| [ ] | `M3B-S01` | Replay viewer shell: event tail, category filter, tick scrubber, pause/step, and bundle loader. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3B-S02` | Cause-chain view for death, mission resolved, reactor destroyed, terrain breach, and projectile hits. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3B-S03` | Debrief summary with outcome, objectives, key events, damage/death recap, terrain changes, and checksum status. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
...
| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [x] | `M0-D01` | `cargo build --release` succeeds on Win/Linux/macOS. | [[spec/prototype-roadmap#M0 — Engine Bootstrap]] | `cargo build --release` clean on macOS aarch64 + rustc 1.95.0 after M0.3 contract fixes. Linux + Windows wired into `.github/workflows/ci.yml`. | - | - | - | 9 | 8 | 2 | Remote runner pass arrives on the first CI push; workflow + Linux deps + Bevy x11 feature already configured. |
...
| [x] | `M1.5-D06` | Run bundle validates and includes screenshot/capture plus objective outcome. | [[spec/prototype-roadmap#M1.5 — Micro Breach Fun Slice]] | All four M1.5 acceptance bundles PASS `python3 game/tools/prototype_run_check.py` with `errors 0`. Objective outcome captured in `mission.mission_resolved` events + scripted notes. Later T-CAPTURE reruns produced M1.5 `summary_grid.png` evidence (for example local bundle `m1.5_2026-05-08T17-02-27Z_fd046e53`), so capture is no longer deferred. | - | - | - | 5 | 5 | 2 | Capture proof is mandatory from BP2 onward and available for BP1 release packaging. |
...
| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M2.5-D01` | The micro scenario can be won and lost in 60-90 seconds using M2 chunked terrain. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - |  |
| [ ] | `M2.5-D02` | Win path proves terrain matters: trench/cover carving count meets threshold and reactor survives. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - |  |
| [ ] | `M2.5-D03` | Loss path proves stakes: reactor can be destroyed with structured `reactor_destroyed` reason. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - |  |
| [ ] | `M2.5-D04` | Run bundles validate, include T-CAPTURE summary grids, and pass at 60 Hz + 120 Hz. | [[spec/prototype-roadmap#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - |  |
| [ ] | `M2.5-D05` | Project-owner playtest reaction is recorded or explicitly marked `READY_FOR_HUMAN_PLAYTEST`. | [[spec/prototype-roadmap#Build Points (Roadmap V2)]] | - | - | - | - | - | - | - |  |

### M3A - Event Recorder Core

| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M3A-D01` | A 5-minute M2/M2.5 run can be replayed headlessly and produces identical actor/terrain/inventory checksums. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3A-D02` | Drift between replay and live run is reported per-tick with `first_divergence` diff. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3A-D03` | Run bundle includes manifest, events, summary, snapshots, checksums, captures, and `expected_outcome`. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3A-D04` | Canonical checker rejects missing/incorrect outcome, malformed events, and replay checksum mismatch. | [[references/prototype-run-bundle-schema]] | - | - | - | - | - | - | - | Negative/adversarial proof required. |
| [ ] | `M3A-D05` | No DR-002 closure attempted; M3A refreshes the lean and records open M3B viewer/debrief closure work. | [[decisions/dr-002-replay-event-architecture]] | - | - | - | - | - | - | - |  |

### M3B - Replay Viewer And Debrief

| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M3B-D01` | Replay viewer can scrub through events and show context. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3B-D02` | Death/mission/reactor recap shows the parent cause chain from event ids. | [[spec/prototype-roadmap#M3 — Replay And Event Recorder]] | - | - | - | - | - | - | - |  |
| [ ] | `M3B-D03` | DR-002 closes with viewer + headless replay + deterministic checksum evidence. | [[decisions/dr-002-replay-event-architecture]] | - | - | - | - | - | - | - |  |
...
| [ ] | `T-CAPTURE-D02` | BP2+ done-criteria: every fun-proof scenario in BP2..BP12 emits `summary_grid.png` + `capture_manifest.json` recorded in `summary.json.artifacts`; cf-e2e includes `--expect capture.summary_grid.non_blank_ratio>=0.95`. | [[spec/prototype-roadmap#T-CAPTURE — Frame Capture, Grid Composer, And BP Fun-Proof Automation]] | Pending: M2.5 micro reactor defense (BP2), M5.5.5 micro sabotage (BP4), M5.9.5 micro pressure hold (BP5), all M7+ proof-mission slices. | - | - | - | - | - | - | Mandatory at every BP closure gate from BP2 onward. |
...
| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [x] | `T-RELEASE-S01` | `.github/workflows/release.yml` triggered on the SemVer prerelease channel tag patterns `v*-prealpha`, `v*-alpha`, `v*-beta`, `v*-rc`, `v1.0.0` (plus legacy `v*-bp*` for backward compat). Build matrix covers `x86_64-unknown-linux-gnu`, `x86_64-pc-windows-msvc`, `x86_64-apple-darwin`, `aarch64-apple-darwin`. | [[spec/prototype-roadmap#T-RELEASE — Per-BP Cross-Platform GitHub Releases]] | `corefall/.github/workflows/release.yml` merged in PR #7; matrix covers Linux, Windows, macOS x86_64, macOS aarch64. Channel triggers added 2026-05-09 (BP2 follow-up). | - | - | - | 5 | 4 | - | Infrastructure exists; release publication rows remain pending until tags run the workflow. |
| [x] | `T-RELEASE-S02` | `game/tools/generate_release_notes.py` reads BP tag + run-bundle summary + `summary_grid.png` + merged-PR bodies; emits release notes payload (hero image + scope summary + run-bundle stats + human-playtest survey + install instructions + determinism contract + linked PRs/vault notes). | [[spec/prototype-roadmap#T-RELEASE — Per-BP Cross-Platform GitHub Releases]] | `corefall/game/tools/generate_release_notes.py` v0.4.0 (bumped 2026-05-09): `parse_tag` now accepts SemVer prerelease channel forms (`v0.<N>.0-prealpha|alpha|beta|rc`) + GA (`v1.0.0`) + legacy (`v0.<N>.0-bp<N>`), enforces channel-boundary contract (rejects e.g. `v0.4.0-prealpha` because BP4 must ship under `alpha`), `previous_bp_tag` searches across all channel forms; release notes title surfaces channel label. Roadmap V2 BP map, BP exemplar bundle prefixes, BP-specific smoke scenarios, strict version-axis validation, `gh pr view`/git fallback PR evidence extraction, PR body excerpts, and `BP_VAULT_NOTES` linked-vault evidence all retained from v0.3.0. `.github/workflows/release.yml` passes `GH_TOKEN` to the generator so GitHub Actions can read merged PR bodies. Local smoke generated BP2 notes containing `M3A`, `micro_reactor_defense`, merged PR rows, and canonical vault notes. | - | - | - | 5 | 4 | 2 | First real proof comes when `v0.1.0-prealpha` tag runs. |
| [x] | `T-RELEASE-S03` | Versioning axis enforced (channel-based, SemVer prerelease identifiers): `v0.<N>.0-prealpha` for BP0..BP3; `v0.<N>.0-alpha` for BP4..BP6; `v0.<N>.0-beta` for BP7..BP9; `v0.<N>.0-rc` for BP10..BP11; `v1.0.0` for BP12 (launch GA). Legacy `v0.<N>.0-bp<N>` accepted for backward compat with already-published releases. Pre-release flag stays ON until BP12. | [[spec/prototype-roadmap#T-RELEASE — Per-BP Cross-Platform GitHub Releases]] | `generate_release_notes.py::parse_tag` (v0.4.0+) accepts the four channel-based forms + GA + legacy bp<N>; rejects tags whose BP falls outside the channel's allowed range (e.g. `v0.4.0-prealpha` rejected because BP4 must use `alpha`); enforces `major=0, patch=0, minor==BP` invariant for pre-1.0 tags; release workflow sets `prerelease=false` only for `v1.0.0`. Validated by 15/15 positive + 7/7 negative parser cases (2026-05-09). | - | - | - | 5 | 4 | - |  |
| [x] | `T-RELEASE-S04` | Per-release artifacts: cf-app + cfctl + cf-e2e binaries + content/ + scripts/cfctl/ + summary_grid.png + exemplar run bundle, packaged per platform (`tar.zst` for Linux/macOS, `zip` for Windows) + SHA256SUMS.txt. | [[spec/prototype-roadmap#T-RELEASE — Per-BP Cross-Platform GitHub Releases]] | `release.yml` stages cf-app/cfctl/cf-e2e, content, cfctl scripts, repo docs, BP exemplar bundle, optional `summary_grid.png`, platform archives, and `SHA256SUMS.txt`. | - | - | - | 5 | 4 | - | First real proof comes when `v0.1.0-prealpha` tag runs. |
| [ ] | `T-RELEASE-D01` | BP1 closure: retroactive `v0.1.0-prealpha` tag from BP1 closure HEAD (was previously planned as `v0.1.0-bp1`; renamed per 2026-05-09 channel migration) with M1.5 summary_grid as hero; all four cross-platform binaries published; release marked pre-release. | [[spec/prototype-roadmap#T-RELEASE — Per-BP Cross-Platform GitHub Releases]] | Pending; `gh release list --repo Madreag/corefall` and `git tag --list 'v*'` returned no releases/tags on 2026-05-09. Publish alongside the channel-migration PR. | - | - | - | - | - | - |  |
...
| [x] | `M0-005` | CI matrix. Build: Apply the CI YAML from the bootstrap recipe; Win/Linux/macOS matrix; `cargo fmt`, `cargo check`, `cargo clippy -D warnings`, `cargo test`, `cfctl observe smoke`, `cfctl run --write-run-bundle` smoke. Tests: CI green when runners available; local commands pass regardless. Anti-scope: No release packaging; no Steam Deck CI yet. | [[spec/native-implementation-backlog#M0 — Engine Bootstrap]] | `corefall/.github/workflows/ci.yml`; final M0.3 local Standard Validation pass on macOS aarch64 + rustc 1.95.0 (68 tests + doctests). | - | - | - | 8 | 8 | 2 | Push to GitHub deferred (no commit/push without explicit user instruction); workflow YAML mirrors the recipe with toolchain pin synced. |
...
| [ ] | `M2-004` | physics integration. Build: Actor collision respects terrain after edits; chunk boundary tests; collision proxy updates within one tick of carve/fill. Tests: Collision after carve/fill tests; actor cannot stand inside newly filled solid. Anti-scope: No full pathfinding. | [[spec/native-implementation-backlog#M2 — Pixel Terrain And Materials]] | - | - | - | - | - | - | - | Owns: `cf-physics`, `cf-terrain`. Evidence target: E2E dig-through-wall. |
| [ ] | `M2-005` | material overlay and tool feedback. Build: Toggle overlay shows material ids, hardness/affordance, and tool validity. Success/refusal labels are non-color-only and visible in captures. Tests: Screenshot/capture at 100/200%; refusal vocabulary tests. Anti-scope: No tactical map. | [[spec/native-implementation-backlog#M2 — Pixel Terrain And Materials]] | - | - | - | - | - | - | - | Owns: `cf-ui`, `cf-render-2d`. Evidence target: Overlay capture + `summary_grid.png` row. |
...
| [ ] | `M2-007` | terrain observability. Build: `cfctl observe --terrain`, `cfctl inspect terrain chunk`, `cfctl inspect material <id>`, and run-bundle material summary. Tests: JSON schema tests; invalid chunk/material id returns structured reason. Anti-scope: No full editor. | [[spec/native-implementation-backlog#M2 — Pixel Terrain And Materials]] | - | - | - | - | - | - | - | Owns: `cf-control`, `cfctl`, `cf-terrain`. Evidence target: `cfctl` transcript in implementation log. |
| [ ] | `M2-008` | loose fill and debris floor. Build: Minimal loose-fill behavior: unsupported loose pixels settle/fall deterministically in bounded dirty regions; carving emits debris particles/loose pixels where configured. Tests: Deterministic settle fixtures; chunk-edge settle tests; perf budget. Anti-scope: No systemic fluids, gases, heat, or full CA chemistry. | [[spec/native-implementation-backlog#M2 — Pixel Terrain And Materials]] | - | - | - | - | - | - | - | Owns: `cf-terrain`, `cf-physics`, `cf-render-2d`. Evidence target: Capture shows visible debris/settling; events include cause and bbox. |
### M2.5 - Micro Reactor Defense Fun Slice

| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M2.5-001` | scenario shell. Build: 60-90s `micro_reactor_defense`: spawn, reactor hp, timer, enemy wave, extraction/survival result. Tests: Manifest validation; objective state tests. Anti-scope: No full mission director. | [[spec/native-implementation-backlog#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - | Owns: `cf-mission`, `content/scenarios/`. Evidence target: `micro_reactor_defense.ron` + scenario summary. |
| [ ] | `M2.5-002` | reactor object. Build: Reactor is a damageable static actor/object with hp, aabb hits, damaged/exploding states, and mission-loss reason `reactor_destroyed`. Tests: Damage routing tests; projectile-to-reactor hit tests. Anti-scope: No base power network yet. | [[spec/native-implementation-backlog#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - | Owns: `cf-actor`, `cf-physics`, `cf-mission`. Evidence target: `actor_status_changed` + `mission_resolved` chain. |
| [ ] | `M2.5-003` | terrain-driven defense. Build: Player must use M2 chunked terrain to dig trench/cover; enemy path/fire reacts to changed terrain affordances enough to prove terrain matters. Tests: Win path requires `terrain_carved >= N`; loss path with no trench fails faster. Anti-scope: No full pathfinding doctrine. | [[spec/native-implementation-backlog#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - | Owns: `cf-terrain`, `cf-equipment`, `cf-ai`. Evidence target: Side-by-side run bundles. |
| [ ] | `M2.5-004` | HUD and feedback. Build: Reactor hp, timer, active objective, enemy pressure, last terrain/refusal event, and material overlay all readable in capture grids. Tests: Capture grid visual checks at 100/200%. Anti-scope: No comic-noir polish. | [[spec/native-implementation-backlog#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - | Owns: `cf-ui`, `cf-render-2d`. Evidence target: `summary_grid.png` referenced by notes. |
| [ ] | `M2.5-005` | win/loss scripts. Build: `defend_win` and `reactor_destroyed` scripts drive the same dispatch path as keyboard/control API. Tests: cf-e2e expectations for mission result, loss reason, terrain count, reactor hp. Anti-scope: No OS-level input automation. | [[spec/native-implementation-backlog#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - | Owns: `cf-e2e`, `scripts/cfctl/`. Evidence target: Bundles at 60 Hz and 120 Hz. |
| [ ] | `M2.5-006` | BP2 fun note. Build: Implementation note answers whether chunked terrain made the game more fun than M1.5 and lists what still feels sterile. Tests: Human gate template filled or `READY_FOR_HUMAN_PLAYTEST`. Anti-scope: Do not claim final fun. | [[spec/native-implementation-backlog#M2.5 — Micro Reactor Defense Fun Slice]] | - | - | - | - | - | - | - | Owns: vault + repo docs. Evidence target: `prototypes/native-m2-5-micro-reactor-defense.md`. |
### M3A - Event Recorder Core

| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M3A-001` | event taxonomy lock. Build: Stable event envelope, category baseline, parent ids, schema versions, and required-field rejection. Tests: Schema/event ordering tests; malformed event rejection tests. Anti-scope: No analytics service. | [[spec/native-implementation-backlog#M3A — Event Recorder Core]] | - | - | - | - | - | - | - | Owns: `cf-replay`, `references/prototype-run-bundle-schema.md`. Evidence target: Updated schema note if fields change. |
| [ ] | `M3A-002` | snapshots/checksums. Build: Actor/inventory/terrain snapshots at scene start/objective changes; deterministic checksums. Tests: Checksum repeatability tests. Anti-scope: No full deterministic promise for cosmetics. | [[spec/native-implementation-backlog#M3A — Event Recorder Core]] | - | - | - | - | - | - | - | Owns: `cf-replay`, `cf-terrain`, `cf-actor`, `cf-equipment`. Evidence target: `snapshot.*` + `determinism.sim_checksum` events. |
| [ ] | `M3A-003` | headless replay verifier. Build: Replay M2/M2.5/M1.5 bundles without rendering and verify checksums. Tests: Replay compare test; 5-minute M2/M2.5 fixture. Anti-scope: No network server yet. | [[spec/native-implementation-backlog#M3A — Event Recorder Core]] | - | - | - | - | - | - | - | Owns: `cf-headless`, `cf-replay`. Evidence target: First-divergence report on failure. |
| [ ] | `M3A-004` | recorder backpressure. Build: Dropped-event counters, non-blocking recorder path, bounded memory, backpressure events. Tests: Stress event-volume test. Anti-scope: No cloud telemetry. | [[spec/native-implementation-backlog#M3A — Event Recorder Core]] | - | - | - | - | - | - | - | Owns: `cf-replay`. Evidence target: Summary volume/perf rows. |
| [ ] | `M3A-005` | run-finished outcome contract. Build: Add `expected_outcome` to `run_manifest.json` constrained to `clean | panic | abort`; checker enforces `system.run_finished` for clean, panic event for panic, and declared abort semantics. Tests: Engine unit/golden tests; live-WS mismatch test. Anti-scope: No retry/restart semantics. | [[spec/native-implementation-backlog#M3A — Event Recorder Core]] | - | - | - | - | - | - | - | Owns: `cf-replay`, `references/prototype-run-bundle-schema.md`, `tools/prototype_run_check.py`. Evidence target: Checker rejects mismatches; acceptance bundles ship `expected_outcome`. |
| [ ] | `M3A-006` | BP2 event audit. Build: Audit M0/M1/M1.5/M2/M2.5 event coverage against every player-visible outcome, failure, terrain edit, AI tactic, and control action. Tests: Contract Integrity Matrix has positive and negative/adversarial rows. Anti-scope: No viewer/debrief UI yet. | [[spec/native-implementation-backlog#M3A — Event Recorder Core]] | - | - | - | - | - | - | - | Owns: vault + repo docs. Evidence target: `prototypes/native-m3a-event-recorder-core.md`. |
### M3B - Replay Viewer And Debrief

| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [ ] | `M3B-001` | viewer shell. Build: Event tail, category filter, tick scrubber, pause/step, and bundle loader. Tests: Viewer smoke test; corrupt bundle rejection. Anti-scope: No polished replay browser. | [[spec/native-implementation-backlog#M3B — Replay Viewer And Debrief]] | - | - | - | - | - | - | - | Owns: `cf-ui`, `cf-replay`, `cf-tools-replay-viewer`. Evidence target: Viewer capture in bundle. |
| [ ] | `M3B-002` | cause-chain view. Build: Parent-chain view for `actor_died`, `mission_resolved`, terrain breach, reactor destroyed, and projectile hit. Tests: Cause-chain golden tests. Anti-scope: No analytics dashboard. | [[spec/native-implementation-backlog#M3B — Replay Viewer And Debrief]] | - | - | - | - | - | - | - | Owns: `cf-ui`, `cf-replay`. Evidence target: Death/failure recap screenshot. |
| [ ] | `M3B-003` | debrief summary. Build: Outcome, objectives, key events, damage/death recap, terrain changes, checksum status. Tests: Debrief layout/capture tests. Anti-scope: No campaign progression UI. | [[spec/native-implementation-backlog#M3B — Replay Viewer And Debrief]] | - | - | - | - | - | - | - | Owns: `cf-ui`, `cf-mission`. Evidence target: Debrief artifact in BP3 note. |
### M4 - HUD And Comic-Noir UI
...
| Done | ID | Feature / Requirement | Source | Evidence | H-Full | H-Quality | H-Review | AI-Full | AI-Quality | AI-Review | Notes |
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| [x] | `VAL-01` | Formatting: `cargo fmt --all --check` | [[spec/prototype-roadmap#Validation Command Matrix]] | macOS aarch64 + rustc 1.95.0 (M0.3 final pass). | - | - | - | 9 | 9 | 1 | Required starting: M0. Pass. |
| [x] | `VAL-02` | Compile: `cargo check --workspace --all-targets` | [[spec/prototype-roadmap#Validation Command Matrix]] | macOS aarch64 + rustc 1.95.0 (M0.3 final pass). | - | - | - | 9 | 9 | 1 | Required starting: M0. Pass. |
| [x] | `VAL-03` | Lints: `cargo clippy --workspace --all-targets -- -D warnings` | [[spec/prototype-roadmap#Validation Command Matrix]] | macOS aarch64 + rustc 1.95.0 (M0.3 final pass). | - | - | - | 9 | 9 | 1 | Required starting: M0. Pass. |
...
| [x] | `VAL-07` | Run-bundle validation: `python3 game/tools/prototype_run_check.py prototype_runs/native/<run_id>` | [[spec/prototype-roadmap#Validation Command Matrix]] | Canonical checker returns `errors 0` for final M0.3 bundles `1ad62cb4`, `2c7f5b05`, `a9675fc6`, and `56e26f4b`. | - | - | - | 9 | 9 | 1 | Required starting: M0. Pass. |
