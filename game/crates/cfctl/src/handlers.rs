...
use crate::cli::{
    ActAction, InspectAction, OutputFormat, ReplayAction, SaveAction, ScenarioAction, ScriptAction,
};
...
pub(crate) async fn cmd_ledger_summary(
    connect: &Option<String>,
    auto_launch_port: u16,
    no_auto_launch: bool,
    format: OutputFormat,
...
pub(crate) fn cmd_replay(action: ReplayAction) -> Result<()> {
...
pub(crate) async fn cmd_observe(
    connect: &Option<String>,
    auto_launch_port: u16,
    no_auto_launch: bool,
    once: bool,
...
pub(crate) fn want_inline_default(inline_flag: bool, once: bool, stream: bool, settings_only: bool) -> bool {
    if inline_flag {
        return true;
    }
    if stream {
...
pub(crate) async fn cmd_scenario(
    connect: &Option<String>,
    auto_launch_port: u16,
    no_auto_launch: bool,
