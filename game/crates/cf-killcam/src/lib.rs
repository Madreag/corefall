...
pub use variant::{
    dispatch_pair_contact_variant, dispatch_variant, ApfsdsThroughModulePayload, HeatPenetrationPayload, KillcamVariant,
    KillcamVariantId, KillcamVariantTrigger, ProjectilePairContactPayload, APFSDS_THROUGH_MODULE_VARIANT_ID,
    DEFAULT_REPLAY_INTERCEPTS, HEAT_PENETRATION_VARIANT_ID, PROJECTILE_PAIR_CONTACT_VARIANT_ID,
};
