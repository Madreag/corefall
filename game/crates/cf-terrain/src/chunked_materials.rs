...
/// air-like physics.
const MATERIAL_TABLE: [MaterialAffordance; 55] = [
    MaterialAffordance {
        id: MATERIAL_AIR,
        name: "air",
        solid: false,
    ...
    MaterialAffordance {
        ...
        spawn_material: None,
        path_cost: 1.5,
        overlay_rgba: [230, 220, 200, 80],
        refusal_reason: None,
    },
    MaterialAffordance {
        id: 67,
        name: "neutralized_brine",
        solid: false,
        diggable: false,
        hardness: 0.0,
        anchorable: false,
