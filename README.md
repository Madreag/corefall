...
| **BP9** | Server / LAN Alpha | M9 (Dedicated Server App) + M10 (LAN Co-op) | LAN co-op smoke + DET-A suite | Planned |
| **BP10** | Online Beta | M11 (Online Co-op + Full Match Grammar) + M9.5 (Voice + Radio) | Self-hosted online co-op + comms | Planned |
