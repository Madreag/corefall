...
- **41 active milestone specs** in [`specs/active/M2.2A..M12.md`](specs/active/) — the executable implementation contracts for the gameplay spine. Each is read-by-implementing-agent-only per AGENTS.md.
