...
| **BP7** | Vertical Slice Alpha | M7 + M7.5 + **M7.6 (Power & Electrical)** + **M7.6.5 (Basic Mining + Smelting)** + M7.7 + **M7.8 (Crafting Tiers)** + M4B | Breach Contract + Bunker Defence proof + power grid + tier ladder + basic mining foundation | Planned |
