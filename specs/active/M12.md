...
**M12 is the visual direction closure** — per DR-019 + DR-046 + DR-055. After M12, the comic-noir aesthetic is fully layered on top of M11's HUD: hand-drawn ink-line UI / panel-bordered banners / dramatic ink-style impact particles / dynamic color grading / animated UI panels / juice rules applied per-surface. M11 is readable; M12 is *cinematic*.

M12 promise: **"the game looks like a high-budget studio production — comic-noir aesthetic with deep tactile feedback."**
...
- Comic-book-style speech bubbles for AI chatter (M37 forward-compat)
