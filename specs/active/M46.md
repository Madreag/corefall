...
| **Day 3 deficit** | Forced demobilization: lowest-priority assets convert to "reserve" state (no upkeep, can't act); player chooses priority via M47 OR auto via storyteller |
| **Day 7 deficit** | Buildings start auto-shutting: factories pause, smelters stop; per-asset reserve duration timer |
| **Day 14 deficit** | Faction enters Resistance Level -1 (pairs with Edit 5.5: M45 graduated collapse) |
| **Day 30 deficit** | Faction collapses or surrenders per M45 endgame storyteller |
