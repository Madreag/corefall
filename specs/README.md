...
|---|---|
| Write a new spec | `Write the spec for M5.5 at specs/active/M5.5.md using specs/_template.md and specs/_planner.md. Pull source from specs/backlog/. Stop when the spec is written — do NOT implement.` |
| Implement a spec | `Implement specs/active/M5.5.md.` |
| Audit completed work | `Audit specs/done/M5.5.md against current code in game/crates/. Report drift.` |
| Mark complete + move on | `Move specs/active/M5.5.md to specs/done/. Write spec for M5.6.` |
